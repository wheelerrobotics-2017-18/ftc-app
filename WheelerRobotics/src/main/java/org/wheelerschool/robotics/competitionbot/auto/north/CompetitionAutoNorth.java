package org.wheelerschool.robotics.competitionbot.auto.north;
...
public abstract class CompetitionAutoNorth extends LinearOpMode {
    CompetitionBot cb;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        int midSegDist = MID_SEG_DIST;

        if (vuMark == RelicRecoveryVuMark.CENTER) {
            telemetry.addData("VU", "CENTER");
        } else if (vuMark == RelicRecoveryVuMark.LEFT) {
            midSegDist += CRYPTO_COLUMN_WIDTH*getSideScale();
