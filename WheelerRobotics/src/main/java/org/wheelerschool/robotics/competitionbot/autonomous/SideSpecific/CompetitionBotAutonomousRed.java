...
public class CompetitionBotAutonomousRed extends CompetitionBotAutonomous {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        this.FIRST_BEACON_PRESS_LOCATION = this.FIRST_BEACON_LOCATION.added(new VectorF(-6.5f * VuforiaLocation.MM_PER_INCH, 0, 0));
        ...
        this.SECOND_BEACON_PRESS_LOCATION = this.SECOND_BEACON_INITIAL_LOCATION.added(new VectorF(-2.25f * VuforiaLocation.MM_PER_INCH, 0, 0));
