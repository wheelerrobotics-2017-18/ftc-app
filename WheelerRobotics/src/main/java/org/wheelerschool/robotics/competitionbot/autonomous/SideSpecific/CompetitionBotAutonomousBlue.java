...
public class CompetitionBotAutonomousBlue extends CompetitionBotAutonomous {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        this.FIRST_BEACON_LOCATION = new VectorF(12 * VuforiaLocation.MM_PER_INCH, 56 * VuforiaLocation.MM_PER_INCH, 0);
        this.FIRST_BEACON_PRESS_LOCATION = this.FIRST_BEACON_LOCATION.added(new VectorF(0, 7f * VuforiaLocation.MM_PER_INCH, 0));
